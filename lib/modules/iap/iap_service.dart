...
class IapService {
  ...
  Future<void> initialize({String? userId}) async {
    ...
    try {
      ...
      await Future.wait([_refreshStatus(), fetchOfferings()]);
  ...
  Future<void> _refreshStatus() async {
    if (!_isInitialized) return;
    try {
      _updateStatus(await Purchases.getCustomerInfo());
    } catch (e, s) {
      Logger.error('Check status failed', error: e, stackTrace: s, tag: _tag);
    }
  }

...
class IsFirstRun {
  ...
  static const String _firstTimeOpenKey = 'is_first_time_open';
  ...
  static Future<bool> check() async {
    try {
      ...
      bool isFirstTime = prefs.getBool(_firstTimeOpenKey) ?? true;

      if (isFirstTime) {
        await prefs.setBool(_firstTimeOpenKey, false);
      }

...
class LocalStorageService {
  ...
  /// Set first run flag
  Future<bool> setFirstRun(bool value) => set(LocalStorageKeys.isFirstRun, value);
  ...
  Future<bool> saveThemeColor(String color) => _prefs.setString(LocalStorageKeys.keyThemeColor, color);

  // ✅ Theme Mode
  String? getThemeMode() => _prefs.getString(LocalStorageKeys.keyThemeMode);

  Future<bool> saveThemeMode(String mode) => _prefs.setString(LocalStorageKeys.keyThemeMode, mode);

  /// Save language code
  Future<bool> saveLanguageCode(String code) => set(LocalStorageKeys.languageCode, code);

...
```dart
// Cho Bloc
import 'package:flutter_base_template/core/state_management/bloc/bloc.dart';

// Cho Cubit
import 'package:flutter_base_template/core/state_management/cubit/cubit.dart';
```
...
| `execute()` | Generic execution | Custom logic |
| `executePagination()` | Load more data | Infinite scroll |

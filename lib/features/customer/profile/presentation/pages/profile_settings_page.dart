...
class _ProfileSettingsPageState extends State<ProfileSettingsPage>
          ...
          _SettingCard(title: 'Môn thể thao yêu thích', children: [
            Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Chọn các môn bạn yêu thích để nhận gợi ý sân phù hợp:',
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
              hintText: label, border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
        ),
        actions: [
  ...
  Widget _verifyBadge(String label, IconData icon) => Container(
        ...
        decoration: BoxDecoration(
            color: AppColors.white.withOpacity(0.2), borderRadius: BorderRadius.circular(20)),
        child: Row(mainAxisSize: MainAxisSize.min, children: [
...
class _SwitchRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ListTile(
        dense: true,
        leading:
            Icon(icon, size: 20, color: value ? AppColors.primaryLightBrand : AppColors.textHint),
...
class _VerifiedChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        child: const Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text('Đã xác minh',
              style:
                  TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.success)),
        ]),
      );
}
...
class _KycRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListTile(
      dense: true,
      leading: Icon(isVerified ? Icons.verified_user_rounded : Icons.shield_outlined,
          color: isVerified ? AppColors.success : AppColors.warning, size: 22),
      ...
      trailing: isVerified
          ...
          : ElevatedButton(
              ...
              child: const Text('Xác minh',
                  style:
                      TextStyle(color: AppColors.white, fontSize: 12, fontWeight: FontWeight.bold)),
            ),
    );
  }
}
          ...
          Row(children: [
            ...
            GestureDetector(
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                    content: Text('📋 Đã sao chép "$code"'), duration: const Duration(seconds: 2)));
              },
              child: Container(
                  padding: const EdgeInsets.all(10),
                  decoration: BoxDecoration(
                      color: AppColors.primaryLightBrand, borderRadius: BorderRadius.circular(10)),
                  child: const Icon(Icons.copy_rounded, color: AppColors.white, size: 18)),
            ),
          ]),
          const SizedBox(height: 8),
          const Text('Chia sẻ mã này với bạn bè để cả hai nhận ưu đãi!',

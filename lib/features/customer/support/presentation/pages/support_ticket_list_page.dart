...
import 'package:dat_san_247_mobile/features/customer/support/presentation/providers/support_notifier.dart';
import 'package:flutter/material.dart';
import 'package:go_router/go_router.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';
import 'package:intl/intl.dart';

class SupportTicketListPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useAsyncValueListener(provider: supportProvider, ref: ref);
    ...
    return Scaffold(
      ...
      body: switch (state) {
        ...
        AsyncData(:final value) => RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) => _TicketCard(ticket: value[index]),
            ),
          ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => _showCreateTicketDialog(context, notifier),
  ...
  void _showCreateTicketDialog(BuildContext context, SupportNotifier notifier) {
    final subjectController = TextEditingController();
    final descriptionController = TextEditingController();
    SupportTicketCategory selectedCategory = SupportTicketCategory.OTHER;
    const selectedPriority = SupportTicketPriority.MEDIUM;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.label_outline, size: 14, color: AppColors.textHint),

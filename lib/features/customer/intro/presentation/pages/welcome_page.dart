...
class _WelcomePageState extends State<WelcomePage> with TickerProviderStateMixin {
  ...
  Widget _buildHeader() {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 8), // Thêm vertical padding
      child: Row(
  ...
  Widget _buildBottomSection() {
    return SingleChildScrollView(
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 16), // Giảm padding
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: const LinearGradient(colors: [Color(0xff62b766), Color(0xff4fa553)]),
                borderRadius: BorderRadius.circular(26), // Điều chỉnh theo height
                boxShadow: [
                  BoxShadow(
              ...
              child: ElevatedButton(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      currentIndex == introData.length - 1 ? 'Bắt Đầu' : 'Tiếp Tục',

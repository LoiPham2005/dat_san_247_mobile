                  ...
                  actions: [
                    IconButton(
                      ...
                      onPressed: () => Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => const StaffSystemNotificationsPage()),
                      ),
                    ),
                  ],
                          ...
                          ProfileSection(
                            ...
                            children: [
                              ProfileMenuRow(
                                ...
                                onTap: () => Navigator.of(
                                  context,
                                ).push(MaterialPageRoute(builder: (_) => const PricingRulesPage())),
                              ),
                              ProfileMenuRow(
            ...
            child: Row(
              children: [
                Icon(
                  ...
                  size: 14,
                  color: p.$2 ? p.$3 : AppColors.borderLight,
                ),
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: p.$2 ? AppColors.textPrimary : AppColors.textHint,
                  ),
                ),
              ],
            ),

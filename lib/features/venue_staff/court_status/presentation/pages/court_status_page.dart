                ...
                child: SafeArea(
                  child: Padding(
                    ...
                    child: Row(children: [
                      ...
                      _QuickStat('$occupied', 'Bận', const Color(0xFF38BDF8)),
                      const SizedBox(width: 16),
                      _QuickStat('$maintenance', 'BT', AppColors.error),
                      const Spacer(),
                      _QuickStat('${_courts.length}', 'Cổng', Colors.white70),
                    ]),
                  ),
                ),
              ),
            ...
            child: Container(
              ...
              child: Row(children: [
                ...
                GestureDetector(
                  ...
                  child: Text('Làm mới',
                      style: TextStyle(fontSize: 11, color: _brand, fontWeight: FontWeight.bold)),
                ),
              ]),
            ),
          ),
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content:
                                  Text('✅ Đã tạo lịch bảo trì${isEmergency ? " (KHẨN CẤP)" : ""}'),

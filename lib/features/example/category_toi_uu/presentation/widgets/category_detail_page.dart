// ════════════════════════════════════════════════════════════════
// 📁 category_toi_uu/presentation/widgets/category_detail_page.dart
// ════════════════════════════════════════════════════════════════
    ...
    return Scaffold(
      ...
      body: BlocBuilder<CategoryBloc, BaseState>(
        builder: (context, state) {
          ...
          // ✅ Nhận Entity (không phải Model)
          if (state.hasData && state.data is CategoryEntity) {
            final category = state.data as CategoryEntity;
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 24),
                  _buildRow('Trạng thái', category.isActive ? 'Hoạt động' : category.status),

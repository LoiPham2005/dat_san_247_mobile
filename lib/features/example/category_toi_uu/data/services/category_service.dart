// ════════════════════════════════════════════════════════════════
// 📁 category_toi_uu/data/services/category_service.dart
// ════════════════════════════════════════════════════════════════
...
/// 🎯 CategoryService — Retrofit auto-generated API client
///
/// Chỉ cần khai báo method signatures + annotations,
/// Retrofit tự gen toàn bộ code gọi HTTP request.
@RestApi()
@LazySingleton()
